...
public class AluguelService {
    ...
    public void delete(Long id) {
        ...
        if(delete == 0) {
            throw new RuntimeException("Aluguel não concentrate!");
        }
    }
    ...
    private Aluguel calculaAluguel(AluguelRequestDTO aluguelRequestDTO) {
        ...
        var quantidadesDias = BigDecimal.valueOf(aluguelRequestDTO.dataFim().getDayOfYear() - aluguelRequestDTO.dataInicio().getDayOfYear());
